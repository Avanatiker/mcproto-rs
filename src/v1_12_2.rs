...
define_protocol!(340, Packet340, RawPacket340, RawPacket340Body, Packet340Kind => {
    // handshaking
...
pub mod tests {
    ...
    packet_test_cases!(RawPacket340
        , Packet340
        , PlayCombatEvent, PlayCombatEventSpec,
    ...
    packet_test_cases!(RawPacket340
        , Packet340
        , PlayFacePlayer, PlayFacePlayerSpec,
    ...
    packet_test_cases!(RawPacket340
        , Packet340
        , PlayEntityMetadata, PlayEntityMetadataSpec,
    ...
    packet_test_cases!(RawPacket340
        , Packet340
        , PlayClientPlayerPositionAndRotation, PlayClientPlayerPositionAndRotationSpec,
    ...
    packet_test_cases!(RawPacket340
        , Packet340
        , PlayPlayerDigging, PlayPlayerDiggingSpec,
    ...
    fn test_generate_test_cases() {
        Packet340::describe().packets.iter().map(move |packet| {
            let snake_case = to_snake_case(packet.name.clone());
            alloc::format!("packet_test_cases!(RawPacket340, Packet340\
